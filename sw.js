// sw.js: cache name follows the app version. v5.52
// Version the import itself so the browser cannot reuse an older worker import.
importScripts('./scripts/version.js?v=5.52');
...
self.addEventListener('install', e => {
  const assets=[
    ...
    './scripts/version.js',
    './scripts/app/main.js',
    './scripts/app/swBootstrap.js?v=5.52',
    './scripts/app/swUpdatePrompt.js?v=5.52',
    './scripts/app/dom.js',
