// sw.js: cache name follows the app version. v5.51
// Version the import itself so the browser cannot reuse an older worker import.
importScripts('./scripts/version.js?v=5.51');
...
self.addEventListener('install', e => {
  const assets=[
    ...
    './scripts/version.js',
    './scripts/app/main.js',
    './scripts/app/swBootstrap.js?v=5.51',
    './scripts/app/swUpdatePrompt.js?v=5.51',
    './scripts/app/dom.js',
