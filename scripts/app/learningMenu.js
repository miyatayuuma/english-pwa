...
function courseLabel(course){
  if(course==='tag') return '連絡先・トレーニング';
...
function refreshChoiceState(dialog){
  ...
  if(start){
    ...
    else if(course==='tag') start.textContent='連絡先・トレーニングを選ぶ';
